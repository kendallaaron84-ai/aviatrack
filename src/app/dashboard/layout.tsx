      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-100 p-4">
        <form onSubmit={handlePasswordLogin} className="p-8 bg-white shadow-md border rounded-xl max-w-md w-full space-y-4">
          ...
          <div className="space-y-3">
            ...
            <input type="email" placeholder="kendallaaron84@gmail.com" value={email} onChange={e => setEmail(e.target.value)} className="w-full rounded-md border p-2 text-sm bg-white" required />
